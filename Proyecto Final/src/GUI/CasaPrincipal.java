...
public class CasaPrincipal extends JPanel implements KeyListener {
    ...
    private void actualizarIndicadorProximidad() {
        ...
        // Prioridad 3: Puerta de Habitación 1 (requiere llave del comedor)
        if (estaEnPuerta1) {
        ...
        // Prioridad 4: Puerta de Habitación 2 (requiere llave de habitación 1)
        if (estaEnPuerta2) {
        ...
        // Prioridad 5: Puertas de pasillos (requieren llave de casa principal)
    ...
    private void collectNearbyObject() {
        ...
        // Mensaje especial al recoger el 5º objeto
